...
from zzz_od.application.auto_obtain_prepaid_power_card.auto_obtain_prepaid_power_card_run_record import \
    AutoObtainPrepaidPowerCardRunRecord

if TYPE_CHECKING:
    from zzz_od.context.zzz_context import ZContext


class AutoObtainPrepaidPowerCardAppFactory(ApplicationFactory):
    ...
    def create_application(self, instance_idx: int, group_id: str) -> Application:
        from zzz_od.application.auto_obtain_prepaid_power_card.auto_obtain_prepaid_power_card_app import \
            AutoObtainPrepaidPowerCardApp
        return AutoObtainPrepaidPowerCardApp(self.ctx)

    def create_config(
        self, instance_idx: int, group_id: str
    ) -> ApplicationConfig:
        return AutoObtainPrepaidPowerCardConfig(
