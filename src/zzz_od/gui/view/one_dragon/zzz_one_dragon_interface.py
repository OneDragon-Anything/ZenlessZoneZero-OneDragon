...
from zzz_od.gui.view.one_dragon.suibian_temple_config_interface import SuibianTempleConfigInterface
...
class ZOneDragonInterface(PivotNavigatorInterface):
    ...
    def create_sub_interface(self):
        ...
        self.add_sub_interface(SuibianTempleConfigInterface(self.ctx))
