...
from zzz_od.application.auto_synthetic.auto_synthetic_config import AutoSyntheticConfig, \
    SourceEtherBatteryAutoSyntheticQuantity
...
class ZOneDragonSettingInterface(VerticalScrollInterface):
    ...
    def get_content_widget(self) -> QWidget:
        ...
        content_widget.add_widget(self.get_auto_synthetic_group())
    ...
    def get_auto_synthetic_group(self) -> QWidget:
        group = SettingCardGroup(gt('自动合成'))

        self.auto_synthetic_hifi_master_copy = SwitchSettingCard(icon=FluentIcon.GAME, title='高保真母盘')

        group.addSettingCard(self.auto_synthetic_hifi_master_copy)
        ...
        group.addSettingCard(self.auto_synthetic_source_ether_battery)
        ...
        group.addSettingCard(self.source_ether_battery_auto_synthetic_quantity)
