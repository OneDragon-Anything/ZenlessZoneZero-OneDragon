...
from zzz_od.gui.view.game_assistant.drive_disk_enhance_interface import DriveDiskEnhanceInterface
...
class GameAssistantInterface(PivotNavigatorInterface):
    ...
    def create_sub_interface(self):
        ...
        self.add_sub_interface(DriveDiskEnhanceInterface(self.ctx))
