...
from zzz_od.gui.dialog.auto_obtain_prepaid_power_card_setting_dialog import AutoObtainPrepaidPowerCardDialog
...
class SharedDialogManager:
    ...
    def __init__(self, ctx: ZContext) -> None:
        ...
        self._auto_obtain_prepaid_power_card_setting_dialog: AutoObtainPrepaidPowerCardDialog | None = None
    ...
    def show_auto_obtain_prepaid_power_card_setting_dialog(
        self,
        parent: QWidget,
        group_id: str,
    ) -> None:
        if self._auto_obtain_prepaid_power_card_setting_dialog is None:
            self._auto_obtain_prepaid_power_card_setting_dialog = AutoObtainPrepaidPowerCardDialog(ctx=self.ctx, parent=parent)

        self._auto_obtain_prepaid_power_card_setting_dialog.show_by_group(
            group_id=group_id,
            parent=parent,
        )
