...
class PcControllerBase(ControllerBase):
    ...
    def _foreground_click(self, pos: Point | None, press_time: float = 0.1, pc_alt: bool = False, low_delay: bool = False) -> bool:
        ...
        if pc_alt:
            ...
            time.sleep(0.2)
        win_click(click_pos, press_time=press_time, low_delay=low_delay)
        if pc_alt:
