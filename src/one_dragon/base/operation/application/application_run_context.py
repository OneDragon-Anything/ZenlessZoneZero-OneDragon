...
class ApplicationRunContext:
    ...
    def get_application(self, app_id: str, instance_idx: int, group_id: str) -> Optional[Application]:
        """
        创建应用实例。
    ...
    def run_application_async(self, app_id: str, instance_idx: int, group_id: str) -> bool:
        """
        异步运行指定的应用。
