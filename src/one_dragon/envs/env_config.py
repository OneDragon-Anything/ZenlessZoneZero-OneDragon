...
class EnvConfig(YamlConfig):
    ...
    @property
    def git_fetch_depth(self) -> int:
        """
        git fetch的深度
        :return:
        """
        return self.get('git_fetch_depth', 50)

    @git_fetch_depth.setter
    def git_fetch_depth(self, new_value: int) -> None:
        """
        git fetch的深度
        :return:
        """
        self.update('git_fetch_depth', new_value)
