...
from qfluentwidgets import (FluentIcon, PushButton, TableWidget, SimpleCardWidget, ScrollArea,
                            ToolButton, CheckBox, LineEdit, BodyLabel)
...
class DevtoolsScreenManageInterface(VerticalScrollInterface):
    ...
    def _init_left_part(self) -> QWidget:
        ...
        widget.add_widget(self.screen_info_opt)

        self.table_widget = self._init_area_table_widget()
        widget.add_widget(self.table_widget, stretch=1)
