...
- **合法 shallow**：遍历在已声明边界停止，可作为该分支自身的增量基线，但不能作为其他分支的完整项目主分支基线。
