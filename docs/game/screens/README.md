...
| 迷失之地 | [迷失之地.md](迷失之地.md) | lost_void 零号空洞战斗肉鸽(层间移动重 app);**已实拍 4 选择/结算画面**(通用选择/武备选择/挑战结果/路径迭换),其余 10 画面(大世界/入口系列/战线肃清/矩阵行动/特遣调查/邦布商店/抽奖机/战斗失败)待补;⚠️通用选择 `按钮-确定` 宽 rect(940px)在 ppocrv6 `crop_first=True` 下漏检 → 整局卡死(故障根因,已切 ppocrv5 缓解,rect 校准中) |
